...
const FAQ_ITEMS = [
  ...
  {
    q: "האם יש התחייבות ארוכת טווח או אפשר לבטל?",
    a: "אין התחייבות ארוכת טווח מצד הלקוח. החיוב הוא חודשי וניתן להפסיק או לצמצם את הרישוי - פרטים מלאים בעמוד המחיר ובשאלות הנפוצות.",
  },
] as const;
