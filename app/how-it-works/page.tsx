      ...
      <main className="mx-auto max-w-5xl px-6">
        ...
        <section className={sectionClass}>
          ...
          <p className={`mt-6 ${cardTextClass} text-sm max-w-2xl`}>
            ברגע שהבוט יוזם - הוא מנהל את התהליך עד סיומו. בסיום, הנתונים חוזרים בצורה מסודרת ל-Priority לפי אחת התוצאות שהוגדרו לו מראש. כחלק מסגירת הטיפול, ובכדי למנוע 'חורים' במידע, המערכת מתעדת את התהליך במלואו: היא מפיקה תקציר AI ושומרת אותו יחד עם היסטוריית השיחה המלאה כקובץ בנספחים של התעודה הרלוונטית. שום פרט לא הולך לאיבוד.
          </p>
        </section>
