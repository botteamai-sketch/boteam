...
const description =
  "שאלות נפוצות על מחולל הבוטים לפריוריטי: מחיר ותשלום, תהליך ההטמעה, אוטומציה בוואטסאפ, אינטגרציה עם ERP, אבטחת מידע ושימושים עסקיים.";
...
const faqs = [
  {
    ...
    question: "מה המחיר?",
    answer:
      "₪120 לחודש לבוט. דמי הקמה חד-פעמיים ₪2,500 (כולל חיבור ל-Priority והטמעה). בוט ראשון חינם ל-3 חודשים, אחר כך מחיר רגיל.",
  },
  {
    category: "מחיר ותשלום",
    question: "למה יש דמי הקמה?",
    answer:
      "דמי הקמה (₪2,500, חד-פעמי) כוללים חיבור מלא ל-Priority, התאמה לתהליכים שלכם והטמעה מלאה. תשלום אחד – ואז רק חודשי.",
  },
  {
    category: "מחיר ותשלום",
    question: "האם יש התחייבות ארוכת טווח?",
    answer:
      "לא. החיוב חודשי וניתן להפסיק בכל עת. אין חוזים ארוכי טווח.",
  },
  {
    category: "מחיר ותשלום",
    question: "מה קורה אחרי 3 חודשי הניסיון של הבוט הראשון?",
    answer:
      "הבוט הראשון מצטרף למחיר הרגיל – ₪120 לחודש.",
  },
  {
    category: "מחיר ותשלום",
    question: "אפשר להוסיף בוטים?",
    answer:
      "כן. בכל שלב, לפי הצורך – ₪120 לחודש לכל בוט נוסף.",
  },
  {
    category: "מחיר ותשלום",
  ...
  },
  {
    ...
    question: "מהם שלבי ההטמעה?",
    answer:
      "התהליך כולל חמישה שלבים: (1) שיחת היכרות והדגמה – מבינים את צווארי הבקבוק ומציגים פתרונות; (2) בחירת מסלול – התאמת רישיונות והסדרת תשלום; (3) הכנת תשתית WhatsApp Business – חיבור מאומת מול Meta עם ליווי מצידנו; (4) התקנת המודול בפריוריטי – ללא כתיבת קוד, עם הרשאות בסיסיות; (5) יציאה לדרך – הגדרת הבוט הראשון מתוך תבניות מוכנות.",
  },
  {
    category: "תהליך ההטמעה",
    question: "כמה זמן לוקח עד שהבוט הראשון עובד?",
    answer:
      "בממוצע, מהשיחה הראשונה ועד בוט פעיל – בין שבועיים לארבעה, תלוי בזמינות הצדדים ובהשלמת חיבור WhatsApp Business.",
  },
  {
    category: "תהליך ההטמעה",
    question: "האם נדרש ידע טכני מצד הלקוח?",
    answer:
      "לא. אתם מספקים הרשאות גישה בסיסיות ומענים על שאלות. את ההתקנה, ההגדרה והחיבור עושים אנחנו.",
  },
  {
    category: "תהליך ההטמעה",
    question: "מה קורה אם אין לנו דף פייסבוק?",
    answer:
      "נדרש דף פייסבוק מאומת לחיבור WhatsApp Business. אנחנו מדריכים אתכם בתהליך האימות מול Meta.",
  },
  {
    category: "תהליך ההטמעה",
    question: "האם אפשר לשנות תהליך או להוסיף בוטים אחרי ה-Go Live?",
    answer:
  ...
  },
  {
    ...
    answer:
      "לא. ניתן להגדיר בוטים לפי צורך – לכל תהליך, מחלקה או צורך ארגוני. כל בוט נוסף – ₪120 לחודש.",
  },
  {
    category: "כללי",
    question: "כמה זמן לוקח להגדיר בוט?",
    answer:
      "ברוב המקרים ניתן להגדיר בוט ראשון תוך דקות, כחלק מהתהליכים הקיימים בפריוריטי, ללא צורך בפיתוח. דמי ההקמה כוללים חיבור והטמעה מלאה.",
  },
  {
