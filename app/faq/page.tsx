...
const faqs = [
  {
    ...
    question: "מה המחיר?",
    answer:
      "₪120 לחודש לבוט. דמי הקמה חד-פעמיים ₪3,500 (כולל חיבור ל-Priority והטמעה). בוט ראשון חינם ל-3 חודשים, אחר כך מחיר רגיל.",
  },
  {
    category: "מחיר ותשלום",
    question: "למה יש דמי הקמה?",
    answer:
      "דמי הקמה (₪3,500, חד-פעמי) כוללים חיבור מלא ל-Priority, התאמה לתהליכים שלכם והטמעה מלאה. תשלום אחד – ואז רק חודשי.",
  },
  {
    category: "מחיר ותשלום",
